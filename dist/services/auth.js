...
var persistAuthHeadersInDeviceStorage = function (Storage, headers) {
    authHeaderKeys.forEach(function (key) {
...
var deleteAuthHeadersFromDeviceStorage = function (Storage) { return __awaiter(void 0, void 0, void 0, function () {
...
var getUserAttributesFromResponse = function (userAttributes, response) {
    var invertedUserAttributes = (0, utility_1.invertMapKeysAndValues)(userAttributes);
